...
export function serializeWorkbenchProfile(profile) {
  ...
  export class Workbench extends HTMLElement {
    ...
    _createWorkbench(portCb) {
      ...
      const config = {
        messagePorts: new Map([["progrium.rig", ch.port1]]),
        productConfiguration: {
          extensionEnabledApiProposals: { "progrium.rig": ["ipc"] },
        ...
        additionalBuiltinExtensions: [
          { scheme, authority: pageUrl.host, path: "/system" },
        ],
  ...
  customElements.define("rig-workbench", Workbench);
